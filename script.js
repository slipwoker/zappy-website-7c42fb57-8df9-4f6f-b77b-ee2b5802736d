document.addEventListener('DOMContentLoaded', function () {
  ...
  function clearFieldError(field) {
    ...
    var existing = field.parentNode.querySelector('.form-error-message');
    ...
    if (value !== '') {
      if (type === 'email' || name.indexOf('email') !== -1) {
        ...
        if (!validatePhone(value)) {
          showFieldError(field, field.dataset.errorPhone || 'Please enter a valid phone number.');
          isValid = false;
        }
      } else if ((type === 'text' || field.tagName.toLowerCase() === 'textarea') && field.minLength > 0) {
        if (value.length < field.minLength) {
          showFieldError(field, field.dataset.errorMinlength || 'Input is too short.');
          isValid = false;
        }
      }
    }
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      var currentFields = contactForm.querySelectorAll('input, textarea, select');
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "אבי בורגר משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '7c42fb57-8df9-4f6f-b77b-ee2b5802736d',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '7c42fb57-8df9-4f6f-b77b-ee2b5802736d';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '7c42fb57-8df9-4f6f-b77b-ee2b5802736d';
